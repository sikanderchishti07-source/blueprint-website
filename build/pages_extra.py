...
ARTICLES = [
    dict(slug="mwan-waste-permit-guide",
         ...
         img="assets/img/blog-mwan.webp",
         fb="assets/img/blog-mwan.webp",
         cat="Waste Permits",
    ...
    dict(slug="environmental-permit-categories",
         ...
         img="assets/img/blog-categories.webp",
         fb="assets/img/blog-categories.webp",
         cat="Permitting",
    ...
    dict(slug="environmental-permit-renewal",
         ...
         img="assets/img/blog-renewal.webp",
         fb="assets/img/blog-renewal.webp",
         cat="Renewals",
    ...
    dict(slug="environmental-compliance-violations",
         ...
         img="assets/img/blog-violations.webp",
         fb="assets/img/blog-violations.webp",
         cat="Inspections",
    ...
    dict(slug="quarry-studies-and-rehabilitation",
         ...
         img="assets/img/blog-quarry.webp",
         fb="assets/img/blog-quarry.webp",
         cat="Quarries & Mining",
