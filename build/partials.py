...
<div id="navMobileDrawer" aria-label="Mobile menu">
  ...
  <div class="drawer-body">
    ...
    """ + ('''<a href="careers.html" class="drawer-link"><div class="drawer-link-icon"><i class="fas fa-user-plus"></i></div>Careers</a>''' if _has_roles() else "") + """
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between" style="height:64px;gap:16px;">
        ...
        <nav class="nav-links" style="flex:1;justify-content:center;" aria-label="Primary">
          ...
          """ + ('''<div class="nav-item"><a href="careers.html" class="nav-link" data-page="careers.html">Careers</a></div>''' if _has_roles() else "") + """
